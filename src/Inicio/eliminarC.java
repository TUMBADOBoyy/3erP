...
public class eliminarC extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(btnEliminar, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 290, -1, -1));
        ...
        jPanel1.add(tfID, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 70, 110, -1));
        ...
        lblNombre.setText("...");
        jPanel1.add(lblNombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 160, -1, -1));

        lblUser.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        lblUser.setText("...");
        jPanel1.add(lblUser, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 190, -1, -1));

        lblPassword.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        lblPassword.setText("...");
        jPanel1.add(lblPassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 220, -1, -1));

        lblRol.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        lblRol.setText("...");
        jPanel1.add(lblRol, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 250, -1, -1));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/t.jpg"))); // NOI18N
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 400, 350));
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        // TODO add your handling code here:
        HttpClient E= new HttpClient(new OnHttpRequestComplete() {
            @Override
            public void onComplete(Response status) {
                if(status.isSuccess()){
                    try{
        ...
        String ID=tfID.getText().toString();
        E.excecute("http://localhost/Api/DeleC.php?ID="+ID+"");
